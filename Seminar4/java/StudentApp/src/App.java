...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        studentService.create("Иван", 25);
        studentService.create("Игорь", 23);
        studentService.create("Иван", 22);
        studentService.create("Даша",  23);

        System.out.println(AccountController.averageAge(studentService.getAll()));

        EmployeeService employeeService = new EmployeeService();
        employeeService.create("Иван", 27);

        TeacherService teacherService = new TeacherService();
        teacherService.create("Иван", 27);
...
//        AccountController.<Teacher, Integer>paySalary(t1, 50000);
//        AccountController.<Employee, Integer>paySalary(e1, 50000);
